...
export function VimeoLitePlayer() {
  ...
  return (
    <div className="group relative mx-auto mt-10 aspect-video w-full max-w-3xl overflow-hidden rounded-[2rem] border border-[rgba(19,49,78,0.1)] bg-[var(--brand-navy)] shadow-[var(--shadow-strong)]">
      <iframe
        ref={iframeRef}
        src={videoSrc}
      ...
      {!isPlaying ? (
        <button
          ...
          className="absolute inset-0 flex items-center justify-center bg-[rgba(18,48,77,0.18)] text-white transition hover:bg-[rgba(18,48,77,0.08)]"
